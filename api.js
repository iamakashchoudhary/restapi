...
var mongourl = "mongodb+srv://akashch720:Opulent@11@cluster0.we1qi.mongodb.net/restproject?retryWrites=true&w=majority";
...
app.get('/',(req,res) => {
    ...
    <a href="http://localhost:7800/mealtype" target="_blank">MealType</a> <br/>
     ...
     <a href="http://localhost:7800/restaurents" target="_blank">Restaurents</a> <br/> 
     <a href="http://localhost:7800/orders" target="_blank">Orders</a>`)
})
